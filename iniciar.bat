@echo off
title Sistema de Filas - Inicializador do Sistema
...
color 0A
echo ===================================================
echo     Sistema de Filas - Sistema de Atendimento Inteligente
echo ===================================================
echo.
...
start "Sistema de Filas - Backend (Python)" cmd /k "cd backend && python main.py"
